...
<article class="page-container">
	<form class="form form-horizontal" id="form-attendance-edit">
	
	<input type="text" id="id" name="id" style="display: none;" value="${attendance.id }"/>
	
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>员工号:</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${attendance.empId }" placeholder="" id="empId" name="empId">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${attendance.attendanceDay }" placeholder="" id="attendanceDay" name="attendanceDay">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${attendance.vocationDay }" placeholder="" id="vocationDay" name="vocationDay">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${attendance.vocationOvertime }" placeholder="" id="vocationOvertime" name="vocationOvertime">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${attendance.dailyOvertime }" placeholder="" id="dailyOvertime" name="dailyOvertime">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${attendance.leaveDay }" placeholder="" id="leaveDay" name="leaveDay">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${attendance.monthDay }" placeholder="" id="monthDay" name="monthDay">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<textarea id="remark" name="remark" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="$.Huitextarealength(this,100)">${attendance.remark }</textarea>
...
<script type="text/javascript">
	function edit(){
		...
		if( empId != "" && attendanceDay != "" && vocationDay != "" && vocationOvertime != "" && dailyOvertime != "" && leaveDay != "" && monthDay != ""){
			$.ajax({
				type:"POST",
				url:"${pageContext.request.contextPath}/attendance/editAttendance",
				data:$("#form-attendance-edit").serialize(),
				dataType:"JSON",
				async:true,
