...
<div class="pd-20">
  ...
  <div class="cl pd-5 bg-1 bk-gray mt-20">
    ...
    <span><a href="javascript:;" onclick="addcar('添加车辆','addCarDisp','','510')" class="btn btn-danger radius" style="position:relative; margin-left:5px;"><i class="icon-trash"></i> 添加基本信息</a></span>
