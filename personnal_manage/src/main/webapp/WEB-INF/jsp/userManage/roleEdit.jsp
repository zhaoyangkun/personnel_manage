...
<article class="page-container">
	...
	<input type="text" value="${role.id }" style="display: none;" name="id" id="id"/>
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${role.nickName }" placeholder="" id="nickName" name="nickName">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${role.phone }" placeholder="" id="phone" name="phone">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="permissions" id="permissions" size="1">
				<c:if test="${role.permissions == 2 }">
					<option value="2" selected="selected">普通用户</option>
				</c:if>
				<c:if test="${role.permissions == 1 }">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<textarea id="remark" name="remark" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="$.Huitextarealength(this,100)">${role.remark }</textarea>
...
/* 		alert(name + " " + nickName + " " + phone); */
		...
		if( name != "" && nickName != "" && phone != "" && checkPhone(phone) == true && $("#password").val() == $("#password2").val()){
			$.ajax({
				type:"POST",
				url:"${pageContext.request.contextPath}/basic/editRole",
