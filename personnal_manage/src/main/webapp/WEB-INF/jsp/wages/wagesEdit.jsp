...
<article class="page-container">
	<form class="form form-horizontal" id="form-wages-edit">
	
	<input type="text" id="id" name="id" style="display: none;" value="${wages.id }"/>
	
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>员工号：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${wages.empId }" placeholder="" id="empId" name="empId">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${wages.name }" placeholder="" id="name" name="name">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${wages.depId }" placeholder="" id="depId" name="depId">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${wages.gjj }" placeholder="" id="gjj" name="gjj">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${wages.ylj }" placeholder="" id="ylj" name="ylj">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${wages.sds }" placeholder="" id="sds" name="sds">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<textarea id="remark" name="remark" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="$.Huitextarealength(this,100)">${wages.remark }</textarea>
...
<script type="text/javascript">
	function edit(){
		...
		if( empId != "" && name != "" && depId != "" && basepay != "" && jbbt != "" &&  gjj != "" && ylj != "" && sds != "" && yfgz != "" && sjgz != ""){
			$.ajax({
				type:"POST",
				url:"${pageContext.request.contextPath}/wages/editWages",
				data:$("#form-wages-edit").serialize(),
				dataType:"JSON",
				async:true,
