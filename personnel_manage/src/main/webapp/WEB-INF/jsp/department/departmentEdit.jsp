...
<article class="page-container">
	<form class="form form-horizontal" id="form-department-edit">
	
	<input type="text" id="id" name="id" style="display: none;" value="${department.id }"/>
	
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>部门名称：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${department.name }" placeholder="" id="name" name="name">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${department.manager }" placeholder="" id="manager" name="manager">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${department.number }" placeholder="" id="number" name="number">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<textarea id="remark" name="remark" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="$.Huitextarealength(this,100)">${department.remark }</textarea>
...
<script type="text/javascript">
	function edit(){
		...
		if( name != "" && manager != "" && number != ""){
			$.ajax({
				type:"POST",
				url:"${pageContext.request.contextPath}/department/editDepartment",
				data:$("#form-department-edit").serialize(),
				dataType:"JSON",
				async:true,
