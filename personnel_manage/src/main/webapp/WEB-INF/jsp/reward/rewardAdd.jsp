...
<article class="page-container">
	<form class="form form-horizontal" id="form-reward-add">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="reward" name="reward">
		</div>
	</div>
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="approvalDep" name="approvalDep">
		</div>
	</div>
		</div>
		<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="head" name="head">
		</div>
	</div>
...
<script type="text/javascript">
	function add(){
		...
		if( empId != "" && name != "" && reward !="" && content !="" 
			...
			$.ajax({
				type:"POST",
				url:"${pageContext.request.contextPath}/reward/rewardAdd",
				data:$("#form-reward-add").serialize(),
				dataType:"JSON",
				async:true,
