...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${reward.empId }" placeholder="" id="name" name="name">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${reward.name }" placeholder="" id="introduce" name="introduce">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>奖/惩</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${reward.reward }" placeholder="" id="introduce" name="introduce">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>奖惩内容</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${reward.content }" placeholder="" id="introduce" name="introduce">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>奖惩原因</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${reward.reason }" placeholder="" id="introduce" name="introduce">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>奖惩金额</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${reward.amount }" placeholder="" id="introduce" name="introduce">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>批准部门</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${reward.approvalDep }" placeholder="" id="introduce" name="introduce">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>负责人</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${reward.head }" placeholder="" id="introduce" name="introduce">
		</div>
	</div>
